...
save_dir = "models/VGGNet/scene_text/{}".format(job_name)
# Directory which stores the snapshot of models.
snapshot_dir = "models/VGGNet/scene_text/{}".format(job_name)
# Directory which stores the job script and log file.
job_dir = "jobs/VGGNet/scene_text/{}".format(job_name)
...
# Stores the test image names and sizes. Created by data/scene_text/create_list.sh
name_size_file = "data/icdar2013/test_name_size.txt"
# The pretrained model. We use the Fully convolutional reduced (atrous) VGGNet.
#pretrain_model = "models/VGGNet/scene_text/SSD_512x512/VGG_scene_text_SSD_512x512_iter_360000.caffemodel"
#pretrain_model = "models/VGGNet/scene_text/SSD_512x512/VGG_scene_text_SSD_512x512_iter_20000.caffemodel"
pretrain_model = "/root/github/ssd-caffe/models/ssd-pretrain/VGG_coco_SSD_512x512_iter_360000.caffemodel"
# Stores LabelMapItem.
...
mbox_layers = CreateMultiBoxHead(net, data_layer='data', from_layers=mbox_source_layers,
        ...
        prior_variance=prior_variance, kernel_size=3, pad=1, lr_mult=lr_mult, conf_postfix='new', loc_postfix='new')
